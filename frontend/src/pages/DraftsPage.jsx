    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        <div className="mt-4 flex md:mt-0 md:ml-4">
          <Button to="/questionnaire" size="lg">
            Create New Poster
          </Button>
        </div>
      </motion.div>
      ...
      {drafts.length === 0 ? (
        ...
        >
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            Create your first poster by answering a few simple questions. Our AI will generate a
        ...
        >
          {drafts.map((draft, index) => (
            <motion.div key={draft.id} variants={itemVariants} layout>
              <Card className="group relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <Button to={`/poster/${draft.id}`} variant="accent" size="sm">
                      View Details
                    </Button>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {draft.responses && (
                      <div className="flex flex-wrap gap-1">
                        {Object.entries(draft.responses)
                          .slice(0, 3)
                          .map(([key, value]) => (
                            <span
                              key={key}
